...
namespace Lab3
{
    class Researcher : Person, IDeepCopy, IComparable<Researcher>, IComparable
    {
        public string Topic { get; set; }
        public int num { get; set; }

        public Researcher(string N = "Res_Name", string L = "Res_Last_Name", DateTime d = new DateTime(), string T = "Math", int n = 1)
        {
            this.Topic = T; 
            this.num = n;
            this.Name[0] = N;
